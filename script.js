document.addEventListener('DOMContentLoaded', () => {
    ...
    const squares = [
        ...
        { name: "好きなストーリーは？", x: 42.6, y: 53.0, event: "好きなストーリーは？" }, // 10
        { name: "好きな必殺技は？", x: 36.4, y: 69.4, event: "好きな必殺技は？" }, // 11
        { name: "次に引きたいキャラは？", x: 40.5, y: 84.7, event: "次に引きたいキャラは？" }, // 12
        { name: "どの運命を歩んでみたい？", x: 52.8, y: 80.9, event: "どの運命を歩んでみたい？" }, // 13
        { name: "よく使う編成は？", x: 62.1, y: 89.0, event: "よく使う編成は？" }, // 14
        { name: "どの組織に入ってみたい？（例：星核ハンター）", x: 64.9, y: 73.1, event: "どの組織に入ってみたい？（例：星核ハンター）" }, // 15
        { name: "手料理を食べてみたいキャラは？", x: 57.0, y: 56.6, event: "手料理を食べてみたいキャラは？" }, // 16
        { name: "完凸無料なら誰凸る？", x: 74.8, y: 86.8, event: "完凸無料なら誰凸る？" }, // 17
        { name: "列車が墜落！？ 1回やすみ", x: 86.5, y: 81.3, event: "列車が墜落！？ 1回やすみ", special: "skip_turn" }, // 18
        { name: "食べてみたい消耗品は？", x: 92.4, y: 65.5, event: "食べてみたい消耗品は？" }, // 19
        { name: "自慢の遺物があれば見せて！", x: 80.7, y: 62.6, event: "自慢の遺物があれば見せて！" }, // 20
        { name: "オシャレだと思うキャラは？", x: 73.1, y: 57.9, event: "オシャレだと思うキャラは？" }, // 21
        { name: "一番の神引きを教えて！", x: 89.9, y: 53.6, event: "一番の神引きを教えて！" }, // 22
        { name: "好きな光円錐は？", x: 67.2, y: 44.5, event: "好きな光円錐は？" }, // 23
        { name: "好きな星神は？", x: 77.0, y: 39.8, event: "好きな星神は？" }, // 24
        { name: "ショートカット！？ Lv0遺物を+3強化！\n【会心率・会心ダメ・速度】のどれかが追加or強化で成功！", x: 51.5, y: 31.9, event: "ショートカット！？ Lv0遺物を+3強化！\n【会心率・会心ダメ・速度】のどれかが追加or強化で成功！", special: "shortcut" }, // 25
        { name: "一番すりぬけで会うキャラは？", x: 66.8, y: 20.8, event: "一番すりぬけで会うキャラは？" }, // 26
